...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-10">
    ...
    <!-- Stat Card 5 (Active App Users) -->
    <div class="glass-card p-6 rounded-2xl flex items-center justify-between">
        <div>
            <span class="text-xs font-semibold text-purple-400 uppercase tracking-wider">Active App Users</span>
            <h3 class="text-4xl font-bold text-white mt-2">{{ $stats['active_app_devices'] }}</h3>
            <span class="text-xs text-gray-400 mt-2 block">{{ $stats['total_devices'] }} Total Installs</span>
        </div>
    ...
    <!-- Stat Card 6 (Active Web Users) -->
    <div class="glass-card p-6 rounded-2xl flex items-center justify-between">
        <div>
            <span class="text-xs font-semibold text-cyan-400 uppercase tracking-wider">Active Web Users</span>
            <h3 class="text-4xl font-bold text-white mt-2">{{ $stats['active_web_devices'] }}</h3>
            <span class="text-xs text-gray-400 mt-2 block">Online on website now</span>
        </div>
        <div class="p-3 bg-cyan-500/10 text-cyan-400 rounded-xl">
            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="glass-panel p-6 rounded-3xl shadow-xl mt-10">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h3 class="text-xl font-bold text-white">Active Devices</h3>
            <p class="text-xs text-gray-400 mt-1">Status of mobile phones and web browsers running AllTV</p>
        </div>
                        ...
                        <td class="p-4">
                            <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-gray-800 border border-gray-700 capitalize flex items-center gap-1.5 w-fit">
                                ...
                                @elseif(strtolower($device->platform) === 'ios')
                                    ...
                                    <span>iOS</span>
                                @elseif(strtolower($device->platform) === 'web')
                                    <svg class="w-3.5 h-3.5 text-cyan-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.6 9h16.8M3.6 15h16.8M12 3a16.2 16.2 0 00-3 9 16.2 16.2 0 003 9m0-18a16.2 16.2 0 013 9 16.2 16.2 0 01-3 9" />
                                    </svg>
                                    <span>Web</span>
                                @else
